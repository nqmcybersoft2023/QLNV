...
//   console.log('Hello');
//   // ngăn chặn quá trình reload lại trang
//   
...
// Hàm chứa các sự kiện khi click nút Xóa hoặc Sửa
document.getElementById('tableDanhSach').onclick = function (event) {
  if (event.target.classList.contains('btn-danger')) {
      deleteUserData(/* lấy thông tin cần xóa */);
  } else if (event.target.classList.contains('btn-warning')) {
      updateUserData(/* lấy thông tin cần sửa */);
  }
}
